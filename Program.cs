...
namespace btvn4
{
    class Program
    {
        ...
        private static void RegisterUI1()
        {
            User user = new User();
        ...
        private static void InputStudentUI()
        {
            ...
            foreach (Student student in liststudent)
            {
                ...
                if (student.Ten_hs == ten_hs)
                {
                    Console.WriteLine("Ten HS ban nhap bi trung ");
        ...
        private static void DeleteStudent()
        {
            ...
            foreach (Student student in liststudent)
            {
                ...
                {
                    Console.WriteLine("Hoc sinh nay ko co trong danh sach!!!");
                    break;
                }
            }
        ...
        private static void EditStudent()
        {
            ...
            foreach (Student student in liststudent)
            {
                ...
                {
                    Console.WriteLine("Ko co ten hoc sinh trong danh sach!!!");
                    break;
                }
